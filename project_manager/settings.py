...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%#c!5q%2tv)r#q^#18%nifw4xjm@dd_kv0_jp*sqa&qq9qla8&')
...
GOOGLE_SHEETS_SPREADSHEET_NAME = config('GOOGLE_SHEETS_SPREADSHEET_NAME', default='ProjectManager')
