"""
Production settings for Project Manager
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='projectmanager'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@projectmanager.com')
